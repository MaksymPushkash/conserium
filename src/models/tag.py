...
from src.models.base import Base, TimestampMixin, UUIDPrimaryKeyMixin, document_tags
...
class TagModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    documents: Mapped[list["DocumentModel"]] = relationship(secondary=document_tags, back_populates="tag_models")
