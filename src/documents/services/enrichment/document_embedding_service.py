...
class DocumentEmbeddingService:
    ...
    async def ensure_embedding(self, document: DocumentModel) -> None:
    ...
    async def _get_document_chunks(self, document_id: UUID) -> list[ChunkModel]:
        return await self._chunk_repo.get_by_document_id(document_id)
