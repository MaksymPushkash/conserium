...
from src.application.services.query_conversation import QueryConversationService
from src.application.services.query_persistence import QueryPersistenceService
...
class QueryOrchestrationService:
    def __init__(self, conversation_store: IConversationStore, uow: IUnitOfWork) -> None:
        self._conversation = QueryConversationService(conversation_store, uow)
        self._persistence = QueryPersistenceService(uow)
