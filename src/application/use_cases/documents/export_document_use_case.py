...
from src.application.dtos.export_dtos import ExportedFileDTO
from src.application.use_cases.documents.base import ensure_document_owner
from src.domain.exceptions import DocumentNotFoundException, ValidationException
...
class ExportDocumentUseCase:
    ...
    async def _load_document(self, dto: GetDocumentDTO) -> DocumentEntity:
...
def document_to_markdown(document: DocumentEntity) -> str:
