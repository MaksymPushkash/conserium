...
from src.infrastructure.database.repositories.collection_workspace_repository import (
    SQLAlchemyCollectionWorkspaceRepository,
)
...
from src.infrastructure.database.repositories.document_processing_outbox_repository import (
    SQLAlchemyDocumentProcessingOutboxRepository,
)
...
from src.infrastructure.database.repositories.flashcard_repository import SQLAlchemyFlashcardRepository
...
from src.infrastructure.database.repositories.telegram_repository import SQLAlchemyTelegramRepository
...
if TYPE_CHECKING:
    ...
    from src.application.ports.persistence.document_processing_outbox_repository import (
...
class SQLAlchemyUnitOfWork(IUnitOfWork):
    def __init__(self, session: AsyncSession) -> None:
        ...
        self.collection_workspace_repo: ICollectionWorkspaceRepository = SQLAlchemyCollectionWorkspaceRepository(session)
        ...
        self.document_processing_outbox_repo: IDocumentProcessingOutboxRepository = SQLAlchemyDocumentProcessingOutboxRepository(session)
        ...
        self.flashcard_repo: IFlashcardRepository = SQLAlchemyFlashcardRepository(session)
        ...
        self.telegram_repo: ITelegramRepository = SQLAlchemyTelegramRepository(session)
