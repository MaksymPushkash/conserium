...
class SQLAlchemyDocumentTagSync(IDocumentTagSync):
    ...
    async def sync_auto_tags(
        ...
        *,
        ...
        manual_tags = [tag for tag in document.tags if not tag.auto]
        ...
        document.tags = manual_tags + [tags_by_name[name] for name in normalized_names]
