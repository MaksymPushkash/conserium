...
from src.domain.exceptions import OAuthAuthenticationException


class GoogleOAuthClient(IOAuthProviderClient):
...
class GithubOAuthClient(IOAuthProviderClient):
    def __init__(self, client_id: str, client_secret: str) -> None:
        self._client_id = client_id
        self._client_secret = client_secret
